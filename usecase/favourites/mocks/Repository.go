...
func (_m *Repository) Delete(ctx context.Context, favouriteDomain *favourites.Domain) (favourites.Domain, error) {
...
func (_m *Repository) GetByID(ctx context.Context, ID int) (favourites.Domain, error) {
...
func (_m *Repository) GetByUserID(ctx context.Context, userID int, page int, limit int) ([]favourites.Domain, int, error) {
...
func (_m *Repository) Store(ctx context.Context, favouriteDomain *favourites.Domain) (favourites.Domain, error) {
	ret := _m.Called(ctx, favouriteDomain)
