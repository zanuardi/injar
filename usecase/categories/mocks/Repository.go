...
func (_m *Repository) Delete(ctx context.Context, categoriesDomain *categories.Domain) (categories.Domain, error) {
...
func (_m *Repository) Find(ctx context.Context) ([]categories.Domain, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) FindAll(ctx context.Context, page int, perpage int) ([]categories.Domain, int, error) {
...
func (_m *Repository) GetByID(ctx context.Context, categoryId int) (categories.Domain, error) {
...
func (_m *Repository) GetByName(ctx context.Context, categoryName string) (categories.Domain, error) {
...
// Store provides a mock function with given fields: ctx, categoriesDomain
func (_m *Repository) Store(ctx context.Context, categoriesDomain *categories.Domain) (categories.Domain, error) {
	ret := _m.Called(ctx, categoriesDomain)
...
// Update provides a mock function with given fields: ctx, categoriesDomain
func (_m *Repository) Update(ctx context.Context, categoriesDomain *categories.Domain) (categories.Domain, error) {
	ret := _m.Called(ctx, categoriesDomain)
